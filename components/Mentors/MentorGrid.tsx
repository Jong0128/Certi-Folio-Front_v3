...
import { ChatModal } from './ChatModal'; // Import unified ChatModal
...
const MOCK_MENTORS: Mentor[] = [
  {
    ...
    bio: 'YC 창업자 출신 Staff Engineer. 프론트엔드 개발자의 커리어 성장과 리더십 전환을 돕습니다. 실리콘밸리 진출 고민이 있으신가요?',
  ...
  },
  {
    ...
    bio: '마이크로 인터랙션과 디자인 시스템 전문가. 당신의 포트폴리오를 돋보이게 만들어 드립니다. 사용자 중심의 사고방식을 함께 길러보아요.',
  ...
  },
  {
    ...
    bio: '엔지니어가 PM처럼 생각하도록 돕습니다. 생산성 도구와 그로스 해킹 전문. 데이터 기반 의사결정 노하우를 공유합니다.',
  ...
  },
  {
    ...
    bio: '대규모 분산 시스템과 성능 최적화 전문. 백엔드 아키텍처 멘토링. 고가용성 시스템 설계에 대한 깊이 있는 대화를 환영합니다.',
  ...
  },
  {
    ...
    bio: '최신 AI 트렌드와 LLM 활용법을 알려드립니다. 데이터 분석부터 모델링까지 실무 프로세스를 경험해보세요.',
  ...
  },
  {
    ...
    bio: '클라우드 인프라 구축과 CI/CD 파이프라인 자동화. 안정적인 서비스 운영을 위한 노하우를 전수합니다.',
...
export const MentorGrid: React.FC<MentorGridProps> = ({ limit, showAll, filterCategory }) => {
  ...
  // Filter Logic
  let displayMentors = MOCK_MENTORS;
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              <div className="relative bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl animate-fade-in-up border border-white/50">
                  ...
                  <div className="space-y-4">
                      <Input label="신청 주제" placeholder="예: 이력서 첨삭, 커리어 상담" />
                      <div>
                  ...
                  <div className="flex gap-3 mt-8">
                      ...
                      <Button variant="primary" className="flex-1" onClick={() => { alert('신청되었습니다!'); closeModal(); }}>신청 완료</Button>
                  </div>
              </div>
          </div>
      )}
